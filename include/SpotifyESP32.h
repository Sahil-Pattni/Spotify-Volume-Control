...
{
public:
  SpotifyESP32(Client &client);
  SpotifyESP32(Client &client, char *bearerToken);
  SpotifyESP32(Client &client, const char *clientId, const char *clientSecret, const char *refreshToken = "");
